...
from data_utils import epiweek_sub, convert_to_epiweek
from utils import pickle_load, pickle_save, load_yaml_params
from metrics import eval_metrics
from eval import WriteRows2CSV
from cpmethods import get_uncertainty_est
from e2ecp import load_all_params
...
def aggregrate_results_across_exps(input_id, clip_idx_list=None, sort_res=False):
    ...
    for w in metrics[regions[0]]:
        ...
        rows.append(cur_row)
    rows += exp_rows
    WriteRows2CSV(rows, f'../../results/csvs/{input_id}_multi_seeds.csv')
